...
const FROM = process.env.EMAIL_FROM || 'Contextual PR Buddy - AI-powered pre-review insights for developers <noreply@example.com>';
const APP_NAME = 'Contextual PR Buddy - AI-powered pre-review insights for developers';
