...
export default function PullRequestsPage() {
  const [items, setItems] = useState<PullRequestsItem[]>([]);
  ...
  const handleDelete = async (id: string) => {
    await fetch(`/api/pull-requests/${id}`, { method: 'DELETE' });
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold">Pull Request Insights</h1>
        <button
      ...
      <p className="text-gray-600 mb-6">View AI-powered code review suggestions</p>
