  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">Contextual PR Buddy - AI-powered pre-review insights for developers</h1>
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">Value Proposition: Provides developers with automated, context-aware suggestions and potential issues *before* submitting a pull request, ensuring higher code quality and faster review cycles for dev teams.
...
Promotion Type: automatic</p>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-gray-600 mb-6">Join thousands of small businesses who trust Contextual PR Buddy - AI-powered pre-review insights for developers.</p>
      ...
      <footer className="border-t py-8">
        <div className="max-w-4xl mx-auto px-6 flex justify-between text-sm text-gray-500">
          <p>© {new Date().getFullYear()} Contextual PR Buddy - AI-powered pre-review insights for developers. All rights reserved.</p>
